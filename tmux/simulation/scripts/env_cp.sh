...
if [ "$WORLD_NAME" = "ingeniarius" ]; then
	...
	# export DATUM_LATITUDE_START=47.3976052
	# export DATUM_LONGITUDE_START=8.5454057
	# export DATUM_LATITUDE_END=47.3976073
	# export DATUM_LONGITUDE_END=8.54533
	export DATUM_LATITUDE_START=47.3975172
	export DATUM_LONGITUDE_START=8.5452641
	export DATUM_LATITUDE_END=47.3975172
	export DATUM_LONGITUDE_END=8.5451315
else
